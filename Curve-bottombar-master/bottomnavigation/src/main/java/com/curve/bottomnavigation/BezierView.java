...
public final class BezierView extends View {
    ...
    public final void setShadowColor(int value) {
        shadowColor = value;
        if (shadowPaint != null) {
            shadowPaint.setShadowLayer(Utils.dipf(getContext(), 2), 0.0F, 0.0F, shadowColor);
        }
        invalidate();
    }
    ...
    private void initializeViews() {
        shadowHeight = Utils.dipf(getContext(), 18);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.bezierInnerWidth = Utils.dipf(getContext(), 110);
        this.bezierInnerHeight = Utils.dipf(getContext(), 0);
    ...
    private void calculateInner() {
        ...
        innerArray[1] = new PointF((float) (bezierX - bezierInnerWidth /3), bezierInnerHeight + extra);
        innerArray[2] = new PointF(bezierX - bezierInnerWidth / 4, bezierInnerHeight + extra);
        innerArray[3] = new PointF((float) (bezierX - bezierInnerWidth / 2.8), height - extra);
        innerArray[4] = new PointF(bezierX, height - extra);
        innerArray[5] = new PointF((float) (bezierX + bezierInnerWidth / 2.8), height - extra);
        innerArray[6] = new PointF(bezierX + bezierInnerWidth / 4, bezierInnerHeight + extra);
        innerArray[7] = new PointF((float) (bezierX + bezierInnerWidth / 2.8), bezierInnerHeight + extra);
