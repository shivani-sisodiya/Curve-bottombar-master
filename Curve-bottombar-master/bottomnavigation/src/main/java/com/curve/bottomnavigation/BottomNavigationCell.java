...
final class BottomNavigationCell extends RelativeLayout {
    ...
    private BottomNavigation.ClickListener onClickListener;
            ...
            if (this.count != null && this.count.equals("empty")) {
                ...
                if (this.count != null) {
                    ...
                    if (var10000.length() >= 3) {
                        BottomNavigationCell var11 = this;
        ...
        if (Build.VERSION.SDK_INT >= 21 && !this.isEnabledCell) {
            ...
            this._$_findCachedViewById(R.id.fl).postDelayed(new Runnable() {
                public final void run() {
                    try {
                        BottomNavigationCell.this._$_findCachedViewById(R.id.fl).setBackgroundColor(0);
    ...
    public final BottomNavigation.ClickListener getOnClickListener() {
        return this.onClickListener;
    }

    public final void setOnClickListener(BottomNavigation.ClickListener value) {
        ...
        if (var10000 != null) {
            var10000.setOnClickListener(new OnClickListener() {
                public final void onClick(View it) {
                    BottomNavigationCell.this.getOnClickListener().onClickItem(new BottomNavigation.Model(0,0));
                }
            });
        }
    ...
    // $FF: synthetic method
    public static void enableCell$default(BottomNavigationCell var0, boolean var1, int var2, Object var3) {
        if ((var2 & 1) != 0) {
            var1 = true;
        }
    ...
    // $FF: synthetic method
    static void animateProgress$default(BottomNavigationCell var0, boolean var1, boolean var2, int var3, Object var4) {
        if ((var3 & 2) != 0) {
            var2 = true;
        }
    ...
    // $FF: synthetic method
    public static float access$getProgress$p(BottomNavigationCell $this) {
        return $this.progress;
    }

    // $FF: synthetic method
    public static void access$setProgress$p(BottomNavigationCell $this, float var1) {
    ...
    final class MeowBottomNavigationCell$animateProgress$$inlined$apply$lambda$1 implements ValueAnimator.AnimatorUpdateListener {
        // $FF: synthetic field
        final BottomNavigationCell this$0;
        // $FF: synthetic field
        ...
        MeowBottomNavigationCell$animateProgress$$inlined$apply$lambda$1(BottomNavigationCell var1, boolean var2, long var3, boolean var5) {
            this.this$0 = var1;
        ...
        public final void onAnimationUpdate(ValueAnimator it) {
            ...
            BottomNavigationCell.access$setProgress$p(this.this$0, this.$enableCell$inlined ? f : 1.0F - f);
        }
    }
}
