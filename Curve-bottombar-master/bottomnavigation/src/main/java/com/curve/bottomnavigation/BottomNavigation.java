package com.curve.bottomnavigation;
...
/**
 * Created by Shivani Sisodiya on 24-11-2021.
 */
...
public final class BottomNavigation extends FrameLayout {
    ...
    private ArrayList<BottomNavigationCell> cells;
    ...
    public BottomNavigation(Context context) {
        ...
        this.selectedId = -1;
        this.defaultIconColor = Color.parseColor("#000000");
        this.selectedIconColor = Color.parseColor("#ffffff");
        this.backgroundBottomColor = Color.parseColor("#ffffff");
        this.circleColor = Color.parseColor("#FF3700B3");
        this.shadowColor = -4539718;
        this.countTextColor = Color.parseColor("#ffffff");
        this.countBackgroundColor = Color.parseColor("FF3700B3");
    ...
    public final ArrayList<BottomNavigationCell> getCells() {
        return this.cells;
    }
    ...
    private void initializeViews() {
        ...
        this.ll_cells.setClipChildren(true);
        this.ll_cells.setClipToPadding(true);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.selectedId == -1) {
            ...
            var10000.setBezierX(Build.VERSION.SDK_INT >= 17 && this.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL ?
                    (float) this.getMeasuredWidth() + Utils.dipf(this.getContext(), 92) : -Utils.dipf(this.getContext(), 92));
        }
    ...
    public final void add(final BottomNavigation.Model model) {
        final BottomNavigationCell cell = new BottomNavigationCell(this.getContext());
...
//        cell.setRippleColor(this.rippleColor);
        cell.setOnClickListener(new ClickListener() {
            ...
            public void onClickItem(Model item) {
                if (BottomNavigation.this.isShowing(model.getId())) {
                    //MeowBottomNavigation.this.onReselectListener.onReselectItem(model);
                }

                if (!cell.isEnabledCell() && !BottomNavigation.access$isAnimating$p(BottomNavigation.this)) {
                    BottomNavigation.show$default(BottomNavigation.this, model.getId(), false, 2, null);
                    BottomNavigation.this.onClickedListener.onClickItem(model);
                } else if (BottomNavigation.access$getCallListenerWhenIsSelected$p(BottomNavigation.this)) {
                    BottomNavigation.access$getOnClickedListener$p(BottomNavigation.this).onClickItem(model);
                }
            }
        });
        cell.disableCell();
    ...
    private void updateAllIfAllowDraw() {
        if (this.allowDraw) {
            Iterable<BottomNavigationCell> $this$forEach$iv = this.cells;

            for (Object element$iv : $this$forEach$iv) {
                BottomNavigationCell it = (BottomNavigationCell) element$iv;
    ...
    private void anim(BottomNavigationCell cell, int id, boolean enableAnimation) {
    ...
    // $FF: synthetic method
    static void anim$default(BottomNavigation var0, BottomNavigationCell var1, int var2, boolean var3, int var4, Object var5) {
        if ((var4 & 4) != 0) {
            var3 = true;
        }
    ...
    public final void show(int id, boolean enableAnimation) {
        ...
        for (int var4 = (this.models).size(); i < var4; ++i) {
            ...
            BottomNavigation.Model model = (BottomNavigation.Model) var10000;
            var10000 = this.cells.get(i);
            BottomNavigationCell cell = (BottomNavigationCell) var10000;
            if (model.getId() == id) {
    ...
    // $FF: synthetic method
    public static void show$default(BottomNavigation var0, int var1, boolean var2, int var3, Object var4) {
        if ((var3 & 2) != 0) {
            var2 = true;
        }
    ...
    public final BottomNavigationCell getCellById(int id) {
    ...
    public final int getModelPosition(int id) {
        ...
        for (int var3 = (this.models).size(); i < var3; ++i) {
            BottomNavigation.Model item = this.models.get(i);
            if (item.getId() == id) {
                return i;
            }
        }
    ...
    public final void setCount(int id, String count) {
        BottomNavigation.Model var10000 = this.getModelById(id);
        if (var10000 != null) {
            int pos = this.getModelPosition(id);
            var10000.setCount(count);
            BottomNavigationCell var5 = this.cells.get(pos);
            var5.setCount(count);
        }
    }
    ...
    public final void clearCount(int id) {
        ...
        if (var10000 != null) {
            ...
            BottomNavigationCell var4 = this.cells.get(pos);
            var4.setCount("empty");
        }
    }
    ...
    // $FF: synthetic method
    public static ReselectListener access$getOnReselectListener$p(BottomNavigation $this) {
        return $this.onReselectListener;
    }

    // $FF: synthetic method
    public static void access$setOnReselectListener$p(BottomNavigation $this, ReselectListener var1) {
        $this.onReselectListener = var1;
    }

    // $FF: synthetic method
    public static boolean access$isAnimating$p(BottomNavigation $this) {
        return $this.isAnimating;
    }

    // $FF: synthetic method
    public static void access$setAnimating$p(BottomNavigation $this, boolean var1) {
        $this.isAnimating = var1;
    }

    // $FF: synthetic method
    public static ClickListener access$getOnClickedListener$p(BottomNavigation $this) {
        return $this.onClickedListener;
    }

    // $FF: synthetic method
    public static void access$setOnClickedListener$p(BottomNavigation $this, ClickListener var1) {
        $this.onClickedListener = var1;
    }

    // $FF: synthetic method
    public static boolean access$getCallListenerWhenIsSelected$p(BottomNavigation $this) {
        return $this.callListenerWhenIsSelected;
    }

    // $FF: synthetic method
    public static void access$setCallListenerWhenIsSelected$p(BottomNavigation $this, boolean var1) {
        $this.callListenerWhenIsSelected = var1;
    }

    // $FF: synthetic method
    public static BezierView access$getBezierView$p(BottomNavigation $this) {
        return $this.bezierView;
    }

    // $FF: synthetic method
    public static void access$setBezierView$p(BottomNavigation $this, BezierView var1) {
    ...
    class MeowBottomNavigation$anim$$inlined$apply$lambda$1 implements ValueAnimator.AnimatorUpdateListener {
        ...
        final float $beforeX;
        // $FF: synthetic field
        final BottomNavigation this$0;
        // $FF: synthetic field
        final long $animDuration$inlined;
        // $FF: synthetic field
        final FastOutSlowInInterpolator $animInterpolator$inlined;
        // $FF: synthetic field
        final BottomNavigationCell $cell$inlined;

        MeowBottomNavigation$anim$$inlined$apply$lambda$1(float var1, BottomNavigation var2, long var3, FastOutSlowInInterpolator var5, BottomNavigationCell var6) {
            this.$beforeX = var1;
            this.this$0 = var2;
        ...
        public final void onAnimationUpdate(ValueAnimator it) {
            ...
            if (newX > this.$beforeX) {
                BottomNavigation.access$getBezierView$p(this.this$0).setBezierX(f * (newX - this.$beforeX) + this.$beforeX);
            } else {
                BottomNavigation.access$getBezierView$p(this.this$0).setBezierX(this.$beforeX - f * (this.$beforeX - newX));
            }
            if (f == 1.0F) {
                BottomNavigation.access$setAnimating$p(this.this$0, false);
            }
    ...
    final class MeowBottomNavigation$anim$$inlined$apply$lambda$2 implements ValueAnimator.AnimatorUpdateListener {
        ...
        MeowBottomNavigation$anim$$inlined$apply$lambda$2(BottomNavigation var1, long var2, FastOutSlowInInterpolator var4) {
            this.this$0 = var1;
        ...
        public final void onAnimationUpdate(ValueAnimator it) {
            float f = it.getAnimatedFraction();
            BottomNavigation.access$getBezierView$p(this.this$0).setProgress(f * 2.0F);
        }
    }
